                    ...
                    <div class="row g-3">
                        <div class="col-md-3 col-lg-5 col-xl-3">
                            <div class="card mb-3" style="border: none;">
                                <div class="card-body text-center text-secondary p-2">
                                    <img src="{{ $LoggedCompanyInfo->profile_image ? Storage::url($LoggedCompanyInfo->profile_image) : asset('Studentdashboard/assets/images/avatar.jpg') }}"
                                        alt="Profile Image" height="100" width="100"
                                        class="rounded-circle mb-3 border border-3 border-success">
                                    <h5 class="card-title fs-6">{{ $LoggedCompanyInfo->name }}</h5>
                                    <hr>
                                    <p class="card-text mb-1">
                                        <a href="tel:{{ $LoggedCompanyInfo->phonenumber }}"
                                            class="text-decoration-none text-success small">{{ $LoggedCompanyInfo->phonenumber }}</a>
                                    </p>
                                    <p class="card-text small">
                                        <a href="mailto:{{ $LoggedCompanyInfo->email }}"
                                            class="text-decoration-none text-success small">{{ $LoggedCompanyInfo->email }}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-2">
                                                ...
                                                <p class="form-control-plaintext small">{{ $LoggedCompanyInfo->name }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-2">
                                                ...
                                                <p class="form-control-plaintext small">{{ $LoggedCompanyInfo->email }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-2">
                                                ...
                                                <p class="form-control-plaintext small">
                                                    {{ $LoggedCompanyInfo->phonenumber }}</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-2">
                                                <label for="nationalTaxNumber" class="form-label small">National Tax
                                                    Number</label>
                                                <p class="form-control-plaintext small">
                                                    {{ $LoggedCompanyInfo->nationaltaxnumber }}</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-2">
                                                <label for="technologies" class="form-label small">Technologies</label>
                                                @php
                                                $technologies = is_string($LoggedCompanyInfo->technologies) ?
                                                json_decode($LoggedCompanyInfo->technologies, true) :
                                                $LoggedCompanyInfo->technologies;
                                                @endphp
                                                <p class="form-control-plaintext small">
                                                    @if (!empty($technologies) && is_array($technologies))
                                                    {{ implode(', ', array_map('trim', $technologies)) }}
                                                    @else
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-2">
                                                ...
                                                <p class="form-control-plaintext small location-text">{!!
                                                    $LoggedCompanyInfo->location !!}</p>
                                            </div>
                                        </div>
