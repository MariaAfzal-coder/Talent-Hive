                    ...
                    <div class="card-body">
                        <div class="hstack justify-content-between gap-2 flex-wrap">
                            <h3 class="fs-5 mb-0 fw-semibold d-flex align-items-center">
                                <a href="{{ route('company.project.detail', $project->id) }}"
                                   class="event-title text-decoration-none text-dark">{{ $project->title }}</a>
                            </h3>
                            <span class="bg-warning-subtle text-warning-emphasis rounded-pill px-3 py-1 text-sm project-status ms-3">
                                {{ $project->status }}
                            </span>
                        </div>
                        <hr>
                        ...
                        <div class="hstack row-gap-3 gap-2 mb-3 align-items-center justify-content-between flex-wrap">
                            <div class="hstack gap-2">
                                <img src="../Inchargedashboard/assets/images/icon/hour-glass.svg" alt="Time">
