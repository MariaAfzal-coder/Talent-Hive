...
<head>
    ...
    <title>Incharge MakeProfile - TalentHive</title>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input required type="text" class="form-control" id="name" name="name"
                                                    value="{{ old('name', $LoggedInchargeInfo->name) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input required type="tel" class="form-control" id="phone" name="phone"
                                                    value="{{ old('phone', $LoggedInchargeInfo->phone) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                @else
                                                <p required id="profileImagePlaceholder" class="mt-2">Add Image and Update</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
