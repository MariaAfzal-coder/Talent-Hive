...
<head>
    ...
    <title>Supervisor EditProfile - TalentHive</title>
...
<body>
    ...
    <h1 class="mb-3 fs-4 fw-semibold">Edit Profile</h1>
                    ...
                    <div class="tab-pane fade show active" id="bio" role="tabpanel">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $LoggedSupervisorInfo->phone_number }}" placeholder="Enter your phone number...">
                            </div>
                            <div class="col-md-12">
                                <label for="biography" class="form-label">Biography</label>
                                <textarea class="form-control" id="biography" name="biography" rows="3" placeholder="Enter your biography...">{{ $LoggedSupervisorInfo->biography }}</textarea>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="mt-2">
                                    <img src="{{ Storage::url($LoggedSupervisorInfo->profile_image) }}" alt="Profile Image" class="img-thumbnail" style="max-width: 150px;">
                                </div>
                                @endif
                                <div class="col-md-12">
                    ...
                    <div class="tab-pane fade" id="education-experience" role="tabpanel">
                        ...
                        <div id="education-container">
                            ...
                            <div class="row mb-3 education-entry">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="education[{{ $index }}][degree]" value="{{ $edu['degree'] ?? '' }}" placeholder="Degree">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="education[{{ $index }}][year]" value="{{ $edu['year'] ?? '' }}" placeholder="Year">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="education[{{ $index }}][university]" value="{{ $edu['university'] ?? '' }}" placeholder="University">
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div id="experience-container">
                            ...
                            <div class="row mb-3 experience-entry">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="experience[{{ $index }}][post_hold]" value="{{ $exp['post_hold'] ?? '' }}" placeholder="Post Held">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="experience[{{ $index }}][from_year]" value="{{ $exp['from_year'] ?? '' }}" placeholder="From Year">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="experience[{{ $index }}][to_year]" value="{{ $exp['to_year'] ?? '' }}" placeholder="To Year">
                                </div>
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="tab-pane fade" id="awards" role="tabpanel">
                        ...
                        <div id="awards-container">
                            ...
                            <div class="row mb-3 award-entry">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="awards_courses[{{ $index }}][title]" value="{{ $award['title'] ?? '' }}" placeholder="Title">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="awards_courses[{{ $index }}][year]" value="{{ $award['year'] ?? '' }}" placeholder="Year">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="awards_courses[{{ $index }}][organization]" value="{{ $award['organization'] ?? '' }}" placeholder="Organization">
                                </div>
                            </div>
                            @endforeach
                        </div>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    document.getElementById('add-education').addEventListener('click', function() {
                        ...
                        const newEducationEntry = `
                            <div class="row mb-3 education-entry">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="education[${index}][degree]" placeholder="Degree">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="education[${index}][year]" placeholder="Year">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="education[${index}][university]" placeholder="University">
                                </div>
                            </div>`;
                    ...
                    document.getElementById('add-experience').addEventListener('click', function() {
                        ...
                        const newExperienceEntry = `
                            <div class="row mb-3 experience-entry">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="experience[${index}][post_hold]" placeholder="Post Held">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="experience[${index}][from_year]" placeholder="From Year">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="experience[${index}][to_year]" placeholder="To Year">
                                </div>
                            </div>`;
                    ...
                    document.getElementById('add-award').addEventListener('click', function() {
                        ...
                        const newAwardEntry = `
                            <div class="row mb-3 award-entry">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="awards_courses[${index}][title]" placeholder="Title">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="awards_courses[${index}][year]" placeholder="Year">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="awards_courses[${index}][organization]" placeholder="Organization">
                                </div>
                            </div>`;
