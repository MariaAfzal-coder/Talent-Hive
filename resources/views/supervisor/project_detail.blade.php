...
<body>
                                ...
                                <div class="hstack gap-2 mb-3">
                                    <div class="project-thumbnail">
                                        <img src="{{ $project->image ? Storage::url($project->image) : asset('Studentdashboard/assets/images/default-project.jpg') }}"
                                            class="img-fluid rounded-circle border object-fit-cover" width="60"
                                            height="60" alt="Project Thumbnail">
                                    </div>
    ...
    <!--       </div>
                    </div> Bootstrap JS and Popper.js -->
                    <script src="{{ asset('Studentdashboard/assets/js/svg-injector.min.js') }}"></script>
<script src="{{ asset('Studentdashboard/assets/vendors/bootstrap/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('Studentdashboard/assets/js/main.js') }}"></script>
</body>
</html>